...
insert  into ` proyecto`(`pro_ID`,`pro_nombre`,`pro_objetivo_general`,`pro_objetivos_especificos`,`pro_descripcion`,`pro_fecha_inicio`,`pro_fecha_fin`,`pro_justificacion`,`det_par_ID_FK`,`pro_fecha_creacion`) values 
(1,'Proyecto scrum','Facilitar la gestión, administración y monitoreo de los proyectos desarrollados por los aprendices del SENA mediante Scrum.','Establecer procesos claros, monitorear entregables y fomentar la mejora continua.',' Gestión de Proyectos scrum','2025-06-01','2025-12-19','Apoyar el desarrollo eficiente de proyectos bajo metodología ágil.',0,'2025-05-01 00:00:00'),
(2,'Comité de evaluación y seguimiento','Implementar un sistema digital que permita gestionar y evaluar las actividades del Comité de Seguimiento y Evaluación, mejorando su eficiencia y efectividad.','Organizar agendas, actas y tareas del comité, evaluar procesos educativos en tiempo real, analizar datos con informes y gráficos, garantizar seguridad con acceso por roles y encriptación.','','2025-06-01','2025-12-19','Modernizar los procesos del comité, mejorar la eficiencia, facilitar la toma de decisiones y fortalecer la transformación digital del SENA.',0,'2025-05-01 00:00:00'),
(3,'O.R.I.A','Implementar un sistema integral de gestión para ambiente y ficha','Facilitar el seguimiento, control y evaluación académica y disciplinaria de los aprendices','optimizacion de registro de informacion antroprometrica','2025-06-01','2025-12-19','Necesidad de un sistema digitalizado para gestión de ambiente y ficha',0,'2025-05-01 00:00:00'),
(4,'Healthy Mind',NULL,NULL,'mente sana','2025-06-01','2025-12-19',NULL,0,'2025-05-01 00:00:00'),
(5,'SIGAF',NULL,NULL,'sistema integral de gestion ambiente y ficha',NULL,'2025-12-19',NULL,0,'2025-05-01 00:00:00');
...
CREATE TABLE `usuario` (
  ...
  `usu_ficha` enum('2998937','6549387') DEFAULT NULL COMMENT 'Número de ficha al que pertenece(solo para aprendices)',
...
insert  into `usuario`(`usu_cedula`,`usu_nombres`,`usu_apellidos`,`usu_correo`,`usu_telefono`,`usu_contraseña`,`rol_sis_ID_FK`,`usu_ficha`,`usu_programa`,`usu_tipodedocumento`) values 
(1000000001,'juan','olivares','juanolivares@gmail.com','3100000000','juan123',2,'',NULL,'CC'),
(1000000002,'katherine paola','blanco','kathe@gmail.com','3200000000','kathe123',2,'',NULL,'CC'),
(1001855307,'jocy hans','charris fernandez','Jocy@gmail.com','3002201010','j123',1,'2998937','ADSO','CC'),
(1010006601,'jean carlos','coronell castro','jean@gmail.com','4235386883','jean123',1,'2998937','ADSO','CC'),
(1016011848,'madeleine','castillo cardenas','madeleine@gmail.com','3000000005','made123',1,'2998937','ADSO','CC'),
(1042251558,'edgar dario','badillo macias','edgar.badillo@gmail.com','3000000001','edgar123',1,'2998937','ADSO','CC'),
(1042251706,'moises','garcia urda','moises@gmail.com','3148687899','moises123',1,'2998937','ADSO','CC'),
(1042254436,'daniel david','muñoz montoya','daniel@gmail.com','3000000003','daniel123',1,'2998937','ADSO','CC'),
(1042852867,'gabriella ','julio cantillo','gabriella@gmail.com','3000000001','gabriella123',1,'2998937','ADSO','CC'),
(1043134580,'franklin ','munzon herrera','franklin@gmail.com','3000000002','franklin123',1,'2998937','ADSO','CC'),
(1043665064,'jorge enrique','burgos lopez','jorgeburgos@gmail.com','3254649897','jorgeburgos',1,'2998937','ADSO','CC'),
(1044600666,'carlos alfonso','arango de la cruz','carlos@gmail.com','3128609809','carlos123',1,'2998937','ADSO','CC'),
(1044604785,'santiago','celin garcia','santiago.celin@gmail.com','3000000004','santiago123',1,'2998937','ADSO','CC'),
(1044607032,'juan david','gutierrez montes','juan@gmail.com','3129800768','juan123',1,'2998937','ADSO','CC'),
(1044607427,'guillermo ','rodriguez trocha','guillermorod@gmail.com','3216475538','guillermo123',1,'2998937','ADSO','CC'),
(1044619072,'isaac david','cantillo julio','isaaccantillo@gmail.com','3127009807','isaaccantillo',1,'2998937','ADSO','CC'),
(1046696769,'santiago jose','fernandez perez','Fernandezsantiago152@gmail.com','3004504333','santiago123',1,'2998937','ADSO','CC'),
(1046813010,'jailer de jesus','lara pineda','jailer@gmail.com','3000000005','jailer123',1,'2998937','ADSO','CC'),
(1047043541,'isaac david','jimenez perea','isaacjim1706@gmail.com','3017110394','isaac123',1,'2998937','ADSO','CC'),
(1047222805,'jhon carlos','sarmiento rodriguez','jhon.sarmiento@gmail.com','3000000006','jhon123',1,'2998937','ADSO','CC'),
(1047336800,'luis gabriel','villareal chico','luis@gmail.com','3006574678','luis123',1,'2998937','ADSO','CC'),
(1048068189,'edgar isacc ','aroca yanes','edgar.aroca@gmail.com','3000000002','edgar123',1,'2998937','ADSO','CC'),
(1048069515,'juan david','orozco almanza','juanorozco@gmail.com','3241756688','juanorozco',1,'2998937','ADSO','CC'),
(1048277496,'ricardo rafael','retamoso gutierrez','ricardo@gmail.com','3000000004','ricardo123',1,'2998937','ADSO','CC'),
(1049931166,'estuardo jesus','villadiego obrian','estuardo@gmail.com','3000000003','estuardo123',1,'2998937','ADSO','CC'),
(1080570745,'briyith lorena','padilla alfaro','briyith@gmail.com','3246757886','briyith123',1,'2998937','ADSO','CC'),
(1081914694,'luisa fernanda','arrieta marquez','luisa@gmail.com','3127688966','luisa123',1,'2998937','ADSO','CC'),
(1085046441,'Jorje luis','Oliveros Mora','oliverosmorjorgeluis@gmail.com','3148606444','jorge123',1,'2998937','ADSO','CC'),
(1129534383,'camilo andres ','villalobos fernandez','camilo@gmail.com ','3247648989','camilo123',1,'2998937','ADSO','CC'),
(1234567890, 'Elemir elias', 'Gomez zarso', 'isaacjim1706@gmail.com', '3013677446', '1S44Cdavid', 3, NULL, NULL, 'CC'),
(1130267265,'yeilis paola','mendoza blanco','yeilismendoza26@gmail.com','3106298355','yeilis123',1,'2998937','ADSO','CC');
