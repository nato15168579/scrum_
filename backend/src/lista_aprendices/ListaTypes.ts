/**
 * Contratos del modulo administrativo de usuarios y fichas.
 *
 * Agrupa DTOs y tipos de respuesta usados por controller y service para que el
 * flujo de creacion, actualizacion e importacion quede tipado de extremo a extremo.
 */
